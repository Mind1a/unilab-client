...
const Faq = () => {
  return (
    <div className="m-auto w-full max-w-[1152px] space-y-6 px-[26px] lg:space-y-22 lg:pr-12 lg:pl-9">
      <div className="space-y-4 lg:space-y-6">
        <h2 className="ml-[8px] text-[24px] font-black text-[#EDFAFF] lg:ml-0 lg:text-[48px]">
          FAQ
        </h2>
